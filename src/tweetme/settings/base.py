...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.media', #nickadd
            ],
        },
    },
]
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, "media-storage"),
...
# AWS_STORAGE_BUCKET_NAME = 'nickest14'
# AWS_ACCESS_KEY_ID = 'AKIAJJFCZKKQOUO2LTFA'
# AWS_SECRET_ACCESS_KEY = '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'
#
